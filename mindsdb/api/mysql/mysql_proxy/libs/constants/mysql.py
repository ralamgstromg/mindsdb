...
DATA_C_TYPE_MAP = {
    ...
    MYSQL_DATA_TYPE.TINYBLOB: CTypeProperties(
        C_TYPES.MYSQL_TYPE_TINY_BLOB, flags=[FIELD_FLAG.BLOB, FIELD_FLAG.BINARY_COLLATION]
    ),
    ...
    MYSQL_DATA_TYPE.MEDIUMBLOB: CTypeProperties(
        C_TYPES.MYSQL_TYPE_MEDIUM_BLOB, flags=[FIELD_FLAG.BLOB, FIELD_FLAG.BINARY_COLLATION]
    ),
    ...
    MYSQL_DATA_TYPE.LONGBLOB: CTypeProperties(
        C_TYPES.MYSQL_TYPE_LONG_BLOB, flags=[FIELD_FLAG.BLOB, FIELD_FLAG.BINARY_COLLATION]
    ),
...
SERVER_VARIABLES = {
    ...
    #"@@system_time_zone": ("America/Bogota", TYPES.MYSQL_TYPE_VAR_STRING, CHARSET_NUMBERS["utf8_general_ci"]),
    "@@system_time_zone": ("America/Bogota", TYPES.MYSQL_TYPE_VAR_STRING, CHARSET_NUMBERS["utf8_general_ci"]),
    "@@time_zone": ("America/Bogota", TYPES.MYSQL_TYPE_VAR_STRING, CHARSET_NUMBERS["utf8_general_ci"]),
    ...
    "@@version": ("8.4.5", TYPES.MYSQL_TYPE_VAR_STRING, CHARSET_NUMBERS["utf8_general_ci"]),
